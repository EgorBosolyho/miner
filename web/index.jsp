                ...
                $.each(data.field, function (key, val) {
                    ...
                    $.each(val, function (keyLine, valLine) {
                        $.each(valLine, function (keyCell, valCell) {
                            ...
                            $('#fieldDiv').append('<button class="button" oncontextmenu="func(' + valCell.lineId + ','
                                + valCell.cellId + '); return false;" onclick="move(' + valCell.lineId + ','
                                + valCell.cellId + ')">' + $value + '</button>');
                        });
                    });
                });
            }
...
<div align="center"><input type="button" value="Старт/Рестарт" onclick="reset()"/></div>
<div align="center" id="fieldDiv">
</div>
